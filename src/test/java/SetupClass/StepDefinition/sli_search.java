...
public class sli_search extends Setupclass {
	...
	public void open_the_website_URL() throws Throwable {
		...
		WebElement old_paid_email = wait.until(ExpectedConditions.elementToBeClickable(
				By.cssSelector("#pg-account-action > div > div:nth-child(2) > div > form > div:nth-child(1) > input")));
		...
		WebElement old_paid_pass = wait.until(ExpectedConditions.elementToBeClickable(
				By.cssSelector("#pg-account-action > div > div:nth-child(2) > div > form > div:nth-child(2) > input")));
		old_paid_pass.sendKeys("Qwerty@1");

		WebElement old_paid_login_btn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
				"#pg-account-action > div > div:nth-child(2) > div > form > div.btn-wrapper.login_btn > input")));
	...
	public void enter_a_keyword_to_search() throws Throwable {
		...
		for (int i = 0; i <= 4; i++) {
			...
			WebElement parent_product = wait
					.until(ExpectedConditions.elementToBeClickable(By.className("productList")));
			Thread.sleep(2000);
		...
		for (int i = 0; i <= 24; i++) {
			...
			WebElement child1_product = wait
					.until(ExpectedConditions.elementToBeClickable(By.className("sli_ac_image")));
			Thread.sleep(1000);
	...
	public void enter_a_keyword_to_search_and_filter() throws Throwable {
		...
		Thread.sleep(4000);
		WebElement View_More = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='view_more']")));
		Thread.sleep(3000);
		View_More.click();
		Thread.sleep(5000);
